package pl.edu.pjatk.tau.labfive.selenium_automationpractice;
...
public class CorrectRegisteryOnDifferentResolutionTest {
    ...
    @Before
        ...
        driver.findElement(By.id("email_create")).sendKeys("kwszeborowski"+numberTest+"tests@wp.pl");
    ...
    public void RegisteryOnDifferentResolutionTest() throws Exception {
        ...
        driver.findElement(By.id("customer_lastname")).sendKeys("Wszeborowski");
        driver.findElement(By.id("customer_lastname")).click();
        driver.findElement(By.id("customer_lastname")).clear();
        driver.findElement(By.id("customer_lastname")).sendKeys("Wszeborowskitest");
        ...
        driver.findElement(By.id("passwd")).sendKeys("12345678QWE");
        ...
        driver.findElement(By.id("address1")).sendKeys("Muchowskiego");
